!function(t) {
    ...
    var a = function(n) {
        var i = typeof n, o = t("meta.foundation-mq"), a = t(".no-js");
        if (o.length || t('<meta class="foundation-mq">').appendTo(document.head), a.length && a.removeClass("no-js"), "undefined" === i)
    ...
    window.Foundation = s, t.fn.foundation = a, function() {
        ...
        var e = Array.prototype.slice.call(arguments, 1), n = this, i = function() {}, o = function() {
    ...
    var n = function(t, e, n, o) {
        ...
        if (e) {
            ...
            a = u.offset.top + u.height <= u.windowDims.height + u.windowDims.offset.top, s = u.offset.top >= u.windowDims.offset.top, r = u.offset.left >= u.windowDims.offset.left, l = u.offset.left + u.width <= u.windowDims.width;
        var f = [a, s, r, l];
        return n ? r === l==!0 : o ? s === a==!0 : - 1 === f.indexOf(!1)
    }, i = function(t, n) {
        if (t = t.length ? t[0] : t, t === e || t === document)
            throw new Error("I'm sorry, Dave. I'm afraid I can't do that.");
        var i = t.getBoundingClientRect(), o = t.parentNode.getBoundingClientRect(), s = document.body.getBoundingClientRect(), a = e.pageYOffset, r = e.pageXOffset;
        return {
            width: i.width,
            height: i.height,
            offset: {
    ...
    e.Keyboard.parseKey = o;
    var s = {}, a = function(n, i, a) {
        var r, l, u, d = s[i], f = o(n);
        return d ? (r = "undefined" == typeof d.ltr ? d : e.rtl() ? t.extend({}, d.ltr, d.rtl) : t.extend({}, d.rtl, d.ltr), l = r[f], u = a[l], void(u && "function" == typeof u ? (u.apply(), (a.handled || "function" == typeof a.handled) && a.handled.apply()) : (a.unhandled || "function" == typeof a.unhandled) && a.unhandled.apply())) : console.warn("Component not defined!")
    };
    ...
    var i = {
        ...
        _init: function() {
            var e, i = this, o = t(".foundation-mq").css("font-family");
            e = n(o);
            for (var s in e)
                i.queries.push({
                    name: s,
    ...
    e.MediaQuery = i, window.matchMedia || (window.matchMedia = function() {
        "use strict";
    ...
    function n(n, s, a, r) {
        function l() {
            n || s.hide(), u(), r && r.apply(s)
        }
        function u() {
            s[0].style.transitionDuration = 0, s.removeClass(d + " " + f + " " + a)
        }
        if (s = t(s).eq(0), s.length) {
            var d = n ? i[0]: i[1], f = n ? o[0]: o[1];
            u(), s.addClass(a).css("transition", "none"), requestAnimationFrame(function() {
                s.addClass(d), n && s.show()
            }), requestAnimationFrame(function() {
                s[0].offsetWidth, s.css("transition", ""), s.addClass(f)
            }), s.one(e.transitionend(s), l)
        }
    }
    var i = ["mui-enter", "mui-leave"], o = ["mui-enter-active", "mui-leave-active"], s = {
        ...
        function i(r) {
            a || (a = window.performance.now()), s = r - a, n.apply(e), t > s ? o = window.requestAnimationFrame(i, e) : (window.cancelAnimationFrame(o), e.trigger("finished.zf.animate", [e]).triggerHandler("finished.zf.animate", [e]))
        }
        var o, s, a = null;
    ...
    "use strict";
    e.Nest = {
        Feather: function(e, n) {
            e.attr("role", "menubar"), n = n || "zf";
            var i = e.find("li").attr({
                role: "menuitem"
            }), o = "is-" + n + "-submenu", s = o + "-item", a = "is-" + n + "-submenu-parent";
            e.find("a:first").attr("tabindex", 0), i.each(function() {
                var e = t(this), n = e.children("ul");
                n.length && (e.addClass("has-submenu " + a).attr({
                    "aria-haspopup": !0,
                    "aria-selected": !1,
                    "aria-expanded": !1,
        ...
        Burn: function(t, e) {
            ...
            t.find("*").removeClass(n + " " + i + " " + o + " has-submenu is-submenu-item submenu is-active").removeAttr("data-submenu").css("display", "")
        }
    }
}(jQuery, window.Foundation), !function(t, e) {
    "use strict";
    var n = function(t, e, n) {
        var i, o, s = this, a = e.duration, r = Object.keys(t.data())[0] || "timer", l =- 1;
        this.restart = function() {
            l =- 1, clearTimeout(o), this.start()
        }, this.start = function() {
            clearTimeout(o), l = 0 >= l ? a : l, t.data("paused", !1), i = Date.now(), o = setTimeout(function() {
                e.infinite && s.restart(), n()
            }, l), t.trigger("timerstart.zf." + r)
        }, this.pause = function() {
            clearTimeout(o), t.data("paused", !0);
            var e = Date.now();
            l -= e - i, t.trigger("timerpaused.zf." + r)
        }
    }, i = function(e, n) {
        var i = e.length;
        0 === i && n();
        ...
        e.each(function() {
            this.complete ? o() : "undefined" != typeof this.naturalWidth && this.naturalWidth > 0 ? o() : t(this).one("load", function() {
                o()
            })
        })
    };
    e.Timer = n, e.onImagesLoaded = i
    ...
    function n(n) {
        if (t.spotSwipe.preventDefault && n.preventDefault(), u) {
            var i, o = n.touches[0].pageX, a = (n.touches[0].pageY, s - o);
            l = (new Date).getTime() - r, Math.abs(a) >= t.spotSwipe.moveThreshold && l <= t.spotSwipe.timeThreshold && (i = a > 0 ? "left" : "right"), i && (n.preventDefault(), e.call(this), t(this).trigger("swipe", i).trigger("swipe" + i))
        }
    }
    function i(t) {
        1 == t.touches.length && (s = t.touches[0].pageX, a = t.touches[0].pageY, u=!0, r = (new Date).getTime(), this.addEventListener("touchmove", n, !1), this.addEventListener("touchend", e, !1))
    }
    function o() {
    ...
    t.fn.addTouch = function() {
        ...
        var e = function(t) {
            var e = t.changedTouches, n = e[0], i = {
                touchstart: "mousedown",
                touchmove: "mousemove",
                touchend: "mouseup"
            }, o = i[t.type], s = document.createEvent("MouseEvent");
            s.initMouseEvent(o, !0, !0, window, 1, n.screenX, n.screenY, n.clientX, n.clientY, !1, !1, !1, !1, 0, null), n.target.dispatchEvent(s)
        }
    }
}(jQuery), !function(t, e) {
    "use strict";
    e(document).on("click.zf.trigger", "[data-open]", function() {
        ...
        var n = e(this).data("closable") || "fade-out";
        t.Motion ? t.Motion.animateOut(e(this), n, function() {
    ...
    var o = function(t) {
        ...
        var i, o = e("[data-resize]");
        o.length && e(window).off("resize.zf.trigger").on("resize.zf.trigger", function(s) {
        ...
        var i, o = e("[data-scroll]");
        o.length && e(window).off("scroll.zf.trigger").on("scroll.zf.trigger", function(s) {
            i && clearTimeout(i), i = setTimeout(function() {
                n || o.each(function() {
    ...
    t.IHearYou = i
}(window.Foundation, window.jQuery), !function(t) {
    "use strict";
    function e(n, i) {
        this.$element = n, this.options = t.extend({}, e.defaults, this.$element.data(), i), Foundation.Nest.Feather(this.$element, "accordion"), this._init(), Foundation.registerPlugin(this, "AccordionMenu"), Foundation.Keyboard.register("AccordionMenu", {
            ENTER: "toggle",
            SPACE: "toggle",
            ARROW_RIGHT: "open",
            ARROW_UP: "up",
    ...
    e.defaults = {
        ...
        this.$element.find("[data-submenu]").not(".is-active").slideUp(0), this.$element.attr({
            ...
            var e = this.id || Foundation.GetYoDigits(6, "acc-menu-link"), n = t(this), i = n.children("[data-submenu]"), o = i[0].id || Foundation.GetYoDigits(6, "acc-menu"), s = i.hasClass("is-active");
            n.attr({
                "aria-controls": o,
                "aria-expanded": s,
                "aria-selected": !1,
        ...
        this.$element.find("li").each(function() {
            ...
            var i, o, s = t(this), a = s.parent("ul").children("li"), r = s.children("[data-submenu]");
            a.each(function(e) {
                return t(this).is(s) ? (i = a.eq(Math.max(0, e - 1)), o = a.eq(Math.min(e + 1, a.length - 1)), t(this).children("[data-submenu]:visible").length && (o = s.find("li:first-child")), t(this).is(":first-child") ? i = s.parents("li").first() : i.children("[data-submenu]:visible").length && (i = i.find("li:last-child")), void(t(this).is(":last-child") && (o = s.parents("li").first().next("li")))) : void 0
            }), Foundation.Keyboard.handleKey(n, "AccordionMenu", {
                open: function() {
                    r.is(":hidden") && (e.down(r), r.find("li").first().focus())
                },
                close: function() {
                    r.length&&!r.is(":hidden") ? e.up(r) : s.parent("[data-submenu]").length && (e.up(s.parent("[data-submenu]")), s.parents("li").first().focus())
                },
                up: function() {
                    i.focus()
                },
    ...
    "use strict";
    function n(i, o) {
        this.$element = i, this.options = t.extend({}, n.defaults, this.$element.data(), o), e.Nest.Feather(this.$element, "drilldown"), this._init(), e.registerPlugin(this, "Drilldown"), e.Keyboard.register("Drilldown", {
            ENTER: "open",
            SPACE: "open",
            ARROW_RIGHT: "next",
            ARROW_UP: "up",
    ...
    n.defaults = {
        ...
        this.$submenuAnchors.each(function() {
            ...
            i.data("savedHref", i.attr("href")).removeAttr("href"), n.children("[data-submenu]").attr({
                "aria-hidden": !0,
                tabindex: 0,
                role: "menu"
            }), e._events(n)
    ...
    }, n.prototype._events = function(e) {
        var n = this;
        e.off("click.zf.drilldown").on("click.zf.drilldown", function(i) {
            if (t(i.target).parentsUntil("ul", "li").hasClass("is-drilldown-submenu-parent") && (i.stopImmediatePropagation(), i.preventDefault()), n._show(e), n.options.closeOnClick) {
                var o = t("body").not(n.$wrapper);
                o.off(".zf.drilldown").on("click.zf.drilldown", function(t) {
                    t.preventDefault(), n._hideAll(), o.off(".zf.drilldown")
                })
            }
        })
        ...
        this.$menuItems.add(this.$element.find(".js-drilldown-back")).on("keydown.zf.drilldown", function(i) {
            var o, s, a = t(this), r = a.parent("ul").children("li");
            r.each(function(e) {
                return t(this).is(a) ? (o = r.eq(Math.max(0, e - 1)), void(s = r.eq(Math.min(e + 1, r.length - 1)))) : void 0
            }), e.Keyboard.handleKey(i, "Drilldown", {
                next: function() {
                    a.is(n.$submenuAnchors) && (n._show(a), a.on(e.transitionend(a), function() {
                        a.find("ul li").filter(n.$menuItems).first().focus()
                    }))
                },
                previous: function() {
                    n._hide(a.parent("ul")), a.parent("ul").on(e.transitionend(a), function() {
                        setTimeout(function() {
                ...
                open: function() {
                    a.is(n.$menuItems) ? a.is(n.$submenuAnchors) && (n._show(a), setTimeout(function() {
                        a.find("ul li").filter(n.$menuItems).first().focus()
                    }, 1)) : (n._hide(a.parent("ul")), setTimeout(function() {
                        a.parent("ul").parent("li").focus()
                    }, 1))
                },
                handled: function() {
        ...
        return this.$submenus.add(this.$element).each(function() {
            ...
            e = n > e ? n : e
        }), n.height = e * this.$menuItems[0].getBoundingClientRect().height + "px", n.width = this.$element[0].getBoundingClientRect().width + "px", n
    ...
    }, e.plugin(n, "Drilldown")
}(jQuery, window.Foundation), !function(t, e) {
    "use strict";
    function n(i, o) {
        this.$element = i, this.options = e.extend({}, n.defaults, this.$element.data(), o), this._init(), t.registerPlugin(this, "Reveal"), t.Keyboard.register("Reveal", {
            ENTER: "open",
            SPACE: "open",
            ESCAPE: "close",
            TAB: "tab_forward",
    ...
    n.defaults = {
        ...
        if (this.id = this.$element.attr("id"), this.isActive=!1, this.$anchor = e(e('[data-open="' + this.id + '"]').length ? '[data-open="' + this.id + '"]' : '[data-toggle="' + this.id + '"]'), this.$anchor.length) {
            var n = this.$anchor[0].id || t.GetYoDigits(6, "reveal");
            this.$anchor.attr({
    ...
    }, n.prototype._makeOverlay = function(t) {
        var n = e("<div></div>").addClass("reveal-overlay").attr({
            tabindex: - 1,
            "aria-hidden": !0
        }).appendTo("body");
    ...
    }, n.prototype._setPosition = function(e) {
        var n = t.Box.GetDimensions(this.$element), i = this.options.fullScreen ? "reveal full": n.height >= .5 * n.windowDims.height ? "reveal": "center";
        "reveal full" === i ? this.$element.offset(t.Box.GetOffsets(this.$element, null, i, this.options.vOffset)).css({
            ...
            width: ""
        }).offset(t.Box.GetOffsets(this.$element, null, i, this.options.vOffset)) : (this.$element.css({
        ...
        this.focusableElements = t.Keyboard.findFocusable(this.$element), this.options.overlay ||!this.options.closeOnClick || this.options.fullScreen || e("body").on("click.zf.reveal", function(t) {
            ...
            }), 0 === n.focusableElements.length && e.preventDefault()
        }), this.$element.on("keydown.zf.reveal", function(i) {
            var o = e(this);
            t.Keyboard.handleKey(i, "Reveal", {
        ...
        this.options.animationOut ? t.Motion.animateOut(this.$element, this.options.animationOut, function() {
            n.options.overlay && t.Motion.animateOut(n.$overlay, "fade-out", function() {})
    ...
    }, t.plugin(n, "Reveal"), "undefined" != typeof module && "undefined" != typeof module.exports && (module.exports = n), "function" == typeof define && define(["foundation"], function() {
        return n
    })
}(Foundation, jQuery);
